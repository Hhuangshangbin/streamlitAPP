...
st.set_page_config(page_title="② NC patients vs. BP patients", page_icon="📈")

st.markdown("# ② NC patients vs. BP patients")
st.write(
...
NC_patient=pd.read_csv("NCBP.csv",encoding="gb18030")
...
st.download_button('OR DOWNLOAD HERE', 'NCBP.csv',
...
if st.button('**Submit the data**'):
    ...
    NC_patient = df
    new_patient = NC_patient[NC_patient.iloc[:, -1] == 'NC']
